**SUMMERVILLE CREDIT UNION · BUSINESS BANKING USER GUIDE · CSUM-11 of 16**

**Business Alerts**

Module: Business Banking \> More \> Business Alerts

**Navigation: Dashboard → Business Banking → More → Business Alerts**
...
Business Alerts enables business members to configure automated notifications for security events, transaction activity, and account changes across their business accounts. The alert configuration is organized by category: Security and Account Alerts, Wire Alerts, ACH Alerts, and Transfer Alerts. Each category contains individual alert types with toggle switches to enable or disable notifications.

The feature supports a master toggle to enable or disable all business alerts, a Show Enabled Alerts filter, and an Expand All option to view all alert categories simultaneously. The system displays the total count of enabled alerts (e.g., 10/18 Enabled) for quick visibility into the current notification configuration.

For credit unions, business alerts are a proactive security and engagement tool. They keep business members informed of account activity in real-time, reducing the window for fraud detection and increasing member confidence in the platform.

**At a Glance**

| **Attribute**            | **Detail**                                                                              |
| ------------------------ | --------------------------------------------------------------------------------------- |
| **Feature Name**         | Business Alerts                                                                         |
| **Module**               | Business Banking \> More \> Business Alerts                                             |
| **Navigation**           | Dashboard → Business Banking → More → Business Alerts                                   |
| **User Roles**           | Business Owner, Authorized Signer, Business Admin                                       |
| **Access Level**         | Role-based; available to users with alert configuration permission                      |
| **Key Actions**          | Enable/Disable alerts by category, Toggle individual alerts, Expand/Collapse categories |
| **Regulatory Relevance** | Fraud detection support, Regulation E notification compliance                           |
...
| --------------------------- | ----------------- | ----------------------------------------------------- | ------------------------------------------------------ |
| Enable Security Alerts      | Business Owner    | Turn on all security and account change notifications | Immediate awareness of unauthorized access attempts    |
| Configure Wire Alerts       | Authorized Signer | Enable alerts for wire transfer activity              | Real-time notification of high-value wire movements    |
| ACH Activity Monitoring     | Business Admin    | Set alerts for ACH debits and credits                 | Monitors automated payment activity for anomalies      |
| Disable Non-Critical Alerts | Business Owner    | Turn off low-priority alerts to reduce noise          | Customizes notification volume to business preferences |

|                                |
| ------------------------------ |
| **03 STEP-BY-STEP USER GUIDE** |

**How to get here: Dashboard → Business Banking → More → Business Alerts**
...
![Figure 1 — Log In and Open the Dashboard](/sessions/admiring-adoring-maxwell/mnt/SUMMERVILLE%20DOCS/Business%20Banking/Business%20Banking%20-Admin%20&%20Reporting/images/image3.png)
...
**Step 3: Navigate to Business Alerts**
...
![Figure 3 — Navigate to Business Alerts](/sessions/admiring-adoring-maxwell/mnt/SUMMERVILLE%20DOCS/Business%20Banking/Business%20Banking%20-Admin%20&%20Reporting/images/image5.png)

*Figure 3 — Navigate to Business Alerts*

**Step 4: Configure Security and Account Alerts**
...
![Figure 4 — Configure Security and Account Alerts](/sessions/admiring-adoring-maxwell/mnt/SUMMERVILLE%20DOCS/Business%20Banking/Business%20Banking%20-Admin%20&%20Reporting/images/image4.png)

*Figure 4 — Configure Security and Account Alerts*

**Step 5: Configure Wire and ACH Alerts**
...
![Figure 5 — Configure Wire and ACH Alerts](/sessions/admiring-adoring-maxwell/mnt/SUMMERVILLE%20DOCS/Business%20Banking/Business%20Banking%20-Admin%20&%20Reporting/images/image1.png)

*Figure 5 — Configure Wire and ACH Alerts*

**Step 6: Configure Transfer Alerts and Save**
...
![Figure 6 — Configure Transfer Alerts and Save](/sessions/admiring-adoring-maxwell/mnt/SUMMERVILLE%20DOCS/Business%20Banking/Business%20Banking%20-Admin%20&%20Reporting/images/image6.png)
