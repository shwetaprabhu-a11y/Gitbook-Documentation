...
The Deactivate / Replace Card feature lets you permanently disable a card or request a replacement when your card is lost, stolen, or damaged. Unlike freezing, deactivation is a permanent action — the card cannot be reactivated once deactivated. If you choose replacement, a digital version of the new card is made available instantly while a physical card is mailed to your address within 5 days.

The flow begins by describing what happened to your card and selecting an action: Deactivate Card only, or Request Replacement and Deactivate the current card. If replacement is selected, you choose whether to receive a physical card, confirm your mailing address, and set a PIN for the replacement card. Once submitted, the current card is immediately disabled.
...
| ----------------------------- | ----------------------------------- | ------------------------------------------------------- | --------------------------------------------------------------- |
| **Report a lost card**        | Member whose card is lost or stolen | Selects Deactivate + Replacement, sets new PIN, submits | Instantly blocks the lost card and issues a digital replacement |
| **Deactivate a damaged card** | Member with a damaged card          | Selects Request Replacement, confirms address, sets PIN | Replacement is issued digitally with physical card to follow    |
| **Permanently close a card**  | Member who no longer needs a card   | Selects Deactivate Card only and confirms               | Card is permanently disabled without issuing a replacement      |
...
![Step 1: Dashboard — navigate to Cards to begin](/sessions/admiring-adoring-maxwell/mnt/SUMMERVILLE%20DOCS/Bill%20Pay,%20Loans,%20and%20Cards/Card%20Lifecycle/images/image4.png)
...
![Step 2: Choose to deactivate only or request a replacement](/sessions/admiring-adoring-maxwell/mnt/SUMMERVILLE%20DOCS/Bill%20Pay,%20Loans,%20and%20Cards/Card%20Lifecycle/images/image1.png)
...
![Step 3: Set your delivery preference and new PIN for the replacement card](/sessions/admiring-adoring-maxwell/mnt/SUMMERVILLE%20DOCS/Bill%20Pay,%20Loans,%20and%20Cards/Card%20Lifecycle/images/image3.png)
...
![Step 4: Deactivation confirmed — the card is permanently disabled](/sessions/admiring-adoring-maxwell/mnt/SUMMERVILLE%20DOCS/Bill%20Pay,%20Loans,%20and%20Cards/Card%20Lifecycle/images/image2.png)
