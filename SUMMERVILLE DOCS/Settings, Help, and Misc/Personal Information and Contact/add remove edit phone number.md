...
| Remove an outdated number | Member who disconnected a phone line | Selects Remove, confirms via modal dialog, completes OTP verification | Reduces clutter in contact records and eliminates risk of OTPs being sent to a number the member no longer controls |
| OTP verification on change | All members making any phone number change | Selects delivery method (text or call), picks the target number, enters the 6-digit code | Prevents unauthorized contact changes; creates an auditable security event |
...
The member navigates to the Summerville CU online banking portal and enters their User ID and password. They click **Log in**.

![Screenshot 1](images/Screenshot_1_1.png)

---

**Step 2 — OTP Verification at Login (Method Selection)**

The system prompts for OTP verification before granting dashboard access. The member selects how to receive the one-time passcode: **Send me a message**, **Call me**, or **Send me an email**.

![Screenshot 2](images/Screenshot_2_2.png)

---

**Step 3 — OTP Phone Number Selection**

If the member selects "Send me a message" or "Call me", they are presented with a list of masked phone numbers on file to choose the delivery destination.

![Screenshot 3](images/Screenshot_3_3.png)

---

**Step 4 — Enter OTP Code**

A 6-digit OTP is sent to the selected number. The member enters the code in the Enter code field and clicks **Submit**. A retry countdown (52 seconds) is shown if the code has not arrived. The member can optionally check **Remember Device/Browser** to skip this step on future logins from the same device.

![Screenshot 4](images/Screenshot_4_4.png)

---

**Step 5 — Dashboard Access**

After successful OTP entry, the member lands on the Dashboard, showing their name, account balances, and navigation options.

![Screenshot 5](images/Screenshot_5_5.png)

---

**Step 6 — Navigate via Profile Switcher (if applicable)**

If the member has multiple profiles (Personal Memberships and/or Business accounts), they may see a profile selection panel. For phone number management, the member selects **Personal Memberships**.

![Screenshot 6](images/Screenshot_6_6.png)

---

**Step 7 — Navigate to Personal Information > Contact Information**

The member clicks **More** in the top navigation, then selects **Personal Information**. The Contact Information tab is displayed by default, showing Primary phone, Primary email, and phone categories (Cellular, Home, Business, Business Cell). Categories without a number show an **Add a new phone number** radio button link.

![Screenshot 7](images/Screenshot_7_7.png)

---

**Step 8 — Enter New Phone Number**

The member clicks the **Add a new phone number** radio button under the desired category (e.g., Cellular). An inline form expands showing a **country code dropdown** (defaulting to United States +1) and a **phone number input field**. The member enters the 10-digit number and clicks **Add new number**. A **Cancel** button is available to discard the entry.

![Screenshot 8](images/Screenshot_8_8.png)

---

**Step 9 — OTP Verification (Method Selection — Logged In)**

After submitting the new number, the system triggers an OTP challenge. The member selects the delivery method: **Send me a message** or **Call me**. This OTP is distinct from the login OTP and specifically authorizes the contact change.

![Screenshot 9](images/Screenshot_9_9.png)

---

**Step 10 — OTP Phone Number Selection (Logged In)**

The member selects which existing phone number should receive the OTP to authorize the change.

![Screenshot 10](images/Screenshot_10_10.png)

---

**Step 11 — Enter OTP Code to Authorize Change**

The member enters the 6-digit code sent to the selected number. The retry countdown (58 seconds) is shown if needed.

![Screenshot 11](images/Screenshot_11_11.png)
...
![Screenshot 12](images/Screenshot_12_12.png)
...
![Screenshot 1](images/Screenshot_1_13.png)

---

**Step 2 — OTP Verification at Login (Method Selection)**

![Screenshot 2](images/Screenshot_2_14.png)

---

**Step 3 — OTP Phone Number Selection**

![Screenshot 3](images/Screenshot_3_15.png)

---

**Step 4 — Enter OTP Code at Login**

![Screenshot 4](images/Screenshot_4_16.png)

---

**Step 5 — Dashboard**

![Screenshot 5](images/Screenshot_5_17.png)

---

**Step 6 — Profile Selection**

![Screenshot 6](images/Screenshot_6_18.png)

---

**Step 7 — Navigate to Personal Information > Contact Information**

The Contact Information tab shows existing phone numbers. Each number has **Edit** and **Remove** links. The member clicks **Edit** next to the number they want to change.

![Screenshot 7](images/Screenshot_7_19.png)

---

**Step 8 — Update Phone Number Inline**

The phone number row expands into an editable inline form pre-populated with the existing number. The country code dropdown (United States +1) remains selectable. The member clears the current number and enters the updated one, then clicks **Update** (or **Cancel** to abort).

![Screenshot 8](images/Screenshot_8_20.png)

---

**Step 9 — OTP Verification (Method Selection)**

Submitting the update triggers an OTP challenge to authorize the change. The member selects delivery method.

![Screenshot 9](images/Screenshot_9_21.png)

---

**Step 10 — OTP Phone Number Selection**

![Screenshot 10](images/Screenshot_10_22.png)

---

**Step 11 — Enter OTP Code**

![Screenshot 11](images/Screenshot_11_23.png)
...
![Screenshot 12](images/Screenshot_12_24.png)
...
![Screenshot 1](images/Screenshot_1_25.png)

---

**Step 2 — OTP Verification at Login (Method Selection)**

![Screenshot 2](images/Screenshot_2_26.png)

---

**Step 3 — OTP Phone Number Selection**

![Screenshot 3](images/Screenshot_3_27.png)

---

**Step 4 — Enter OTP Code at Login**

![Screenshot 4](images/Screenshot_4_28.png)

---

**Step 5 — Dashboard**

![Screenshot 5](images/Screenshot_5_29.png)

---

**Step 6 — Profile Selection**

![Screenshot 6](images/Screenshot_6_30.png)

---

**Step 7 — Navigate to Personal Information > Contact Information**

The Contact Information tab lists all existing numbers. The member clicks **Remove** next to the number they want to delete.

![Screenshot 7](images/Screenshot_7_31.png)
...
![Screenshot 8](images/Screenshot_8_32.png)

---

**Step 9 — OTP Verification (Method Selection)**

After confirming the modal, the system triggers an OTP challenge. The member selects the delivery method.

![Screenshot 9](images/Screenshot_9_33.png)

---

**Step 10 — OTP Phone Number Selection**

![Screenshot 10](images/Screenshot_10_34.png)

---

**Step 11 — Enter OTP Code**

![Screenshot 11](images/Screenshot_11_35.png)
...
![Screenshot 12](images/Screenshot_12_36.png)

---

### 3.3 Decision Points & Branching

- **OTP delivery method:** If the member has only phone numbers on file (no email), the login OTP screen will show only "Send me a message" and "Call me" — no email option. If the member has email registered, "Send me an email" appears as a third option.
...
- **Cancel at any point:** The member can click Cancel during the inline form entry to discard changes without triggering an OTP challenge.
- **OTP retry:** If the code is not received within the countdown window, a "Retry" option becomes active. The member can also select another delivery method.
...
- Add: *"New phone number has been added successfully."*
- Edit: *"Phone number has been updated successfully."*
- Remove: *"Phone number has been removed successfully."*
...
| Cancel during flow | Returns to Contact Information with no changes applied | Member can restart the add/edit/remove action |
...
The entry point for all phone management workflows. Members authenticate with User ID and password before any contact information can be viewed or modified.

| Field / Element | Type | Description | Notes |
|---|---|---|---|
| User ID field | Text input | Member's online banking username | Pre-filled if "Save User ID" was previously enabled |
| Password field | Password input | Member's account password | Masked; show/hide toggle available |
...
Shown when the member selects "Send me a message" or "Call me". Lists masked phone numbers available for OTP delivery.
...
| Primary phone | Dropdown/Label | Displays the member's primary phone (masked) | Can be changed via dropdown if multiple numbers exist |
| Primary email | Dropdown/Label | Displays the member's primary email (masked) | Read-only in this context |
...
Appears when the member clicks Remove on an existing phone number.
...
*This guide was prepared using the nFinia platform as deployed at Summerville Credit Union. Screen behavior and field availability may vary based on individual member profile configuration and account type.*
