...
*Step 1 — Login screen: Member enters credentials*
...
*Step 2 — OTP method selection: Choose SMS, call, or email*
...
*Step 3 — Select the phone number to receive the OTP*
...
*Step 4 — Enter the OTP code and optionally remember the device*
...
*Step 5 — Dashboard: Navigate to More*
...
*Step 6 — Profile selector: Choose View Personal Information*
...
*Step 7 — Contact Information: Enter new email address in the inline input field*
...
*Step 8 — Success: New email ID has been added successfully*
...
*Step 7 (Edit) — Contact Information: Edit the email address inline*
...
*Step 8 (Edit) — Success: Email ID has been updated successfully*
...
*Step 7 (Remove) — Contact Information: Multiple emails shown with Remove option*
...
*Step 8 (Remove) — Confirmation modal: Do you want to remove this email ID?*
...
*Step 9 (Remove) — Success: Email ID has been removed successfully*
...
*Login Screen — Summerville CU nFinia portal*
...
*Phone Number Selection Screen for OTP delivery*
...
*OTP Entry Screen — Enter the 5-digit code*
...
*Dashboard — Navigate via More to reach Contact Information*
...
*Profile Selector — Choose Personal Memberships or a Business profile*
...
*Contact Information — Add a new email address inline*
...
*Contact Information — Edit email address inline with Save changes / Cancel*
...
*Removal Confirmation Modal — Confirm or Cancel*
...
*Success — New email ID has been added successfully*

<img src="images/image_24.png">

*Success — Email ID has been updated successfully*

<img src="images/image_25.png">

*Success — Email ID has been removed successfully*
...
*This guide was produced using the nFinia platform as deployed at Summerville Credit Union. Navigation paths, field names, and screen layouts reflect the Summerville CU instance. Feature behavior may vary based on credit union configuration settings.*
