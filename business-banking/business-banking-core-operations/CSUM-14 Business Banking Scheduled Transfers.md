**SUMMERVILLE CREDIT UNION · BUSINESS BANKING USER GUIDE · CSUM-14 of 16**

**Scheduled Transfers**

Module: Business Banking > Payments > Scheduled Transfers

**Navigation: Dashboard → Business Banking → Payments → Scheduled Transfers**

*Sources: Summerville Reports Series A + Series B | Features: nFinia Documentation Features Spreadsheet*

## PRODUCT SUMMARY

Scheduled Transfers provides visibility and management of all pending and future-dated transfers configured by business members. The interface organizes scheduled items by type: Active Scheduled (currently scheduled), External Account (transfers to external banks), Fund Transfer, Template-based, and File Upload-based. Each entry displays the source account, destination, schedule details, and amount.

The feature allows business members to review upcoming payment obligations, cancel or modify scheduled transfers before execution, and track template-driven and file-driven scheduled payments alongside individual transfers. This consolidated view ensures no scheduled payment is overlooked.

For credit unions, scheduled transfer management is a cash management essential that helps business members plan their payment obligations and maintain adequate account balances. It reduces failed payment incidents caused by insufficient funds or forgotten scheduling.
...
| Attribute            | Detail                                                        |
| -------------------- | ------------------------------------------------------------- |
| Feature Name         | Scheduled Transfers                                           |
| Module               | Business Banking > Payments > Scheduled Transfers             |
| Navigation           | Dashboard → Business Banking → Payments → Scheduled Transfers |
| User Roles           | Business Owner, Authorized Signer                             |
| Access Level         | Role-based; visible based on payment permissions              |
| Key Actions          | View scheduled, Cancel, Modify, Filter by type                |
| Regulatory Relevance | Payment scheduling compliance, Regulation E pre-authorization |
...
| --------------------------- | ----------------- | --------------------------------------------------- | ---------------------------------------------------------- |
| Review Upcoming Payments    | Business Owner    | View all scheduled transfers for the coming week    | Ensures adequate account balances for upcoming obligations |
| Cancel Scheduled Transfer   | Authorized Signer | Cancel a pending external transfer before execution | Prevents unwanted or duplicate payments                    |
| Monitor Template Executions | Business Admin    | Track scheduled template-based payment runs         | Oversight of automated payment workflows                   |
| External Transfer Review    | Business Owner    | Filter to see only external bank transfers          | Focused view of outbound payment obligations               |


## STEP-BY-STEP USER GUIDE

**How to get here: Dashboard → Business Banking → Payments → Scheduled Transfers**
...
**Step 3: Navigate to Scheduled Transfers**
...
<figure><img src="/.gitbook/assets/img_97034a5b736d.png" alt="Figure 3 — Navigate to Scheduled Transfers" width="620"><figcaption></figcaption></figure>

*Figure 3 — Navigate to Scheduled Transfers*

**Step 4: Filter to External Account Transfers**
...
<figure><img src="/.gitbook/assets/img_d584709698a9.png" alt="Figure 4 — Filter to External Account Transfers" width="620"><figcaption></figcaption></figure>
