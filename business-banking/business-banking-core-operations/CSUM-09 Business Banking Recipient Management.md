...
| Key Actions          | View recipients, Add new account, Edit account, Delete account, Search |
| Regulatory Relevance | BSA/AML recipient verification, OFAC screening                         |
...
| -------------------------- | ----------------- | ------------------------------------------------------- | ------------------------------------------------------- |
| Add Vendor Account         | Business Owner    | Add new external bank account for vendor payments       | Pre-validates account details to prevent payment errors |
| Review Recipient Directory | Authorized Signer | Browse saved accounts before initiating transfer        | Quick lookup of verified payment destinations           |
| Edit Account Details       | Business Admin    | Update routing or account number for existing recipient | Maintains accurate payment information                  |
| Remove Inactive Recipient  | Business Owner    | Delete accounts for vendors no longer in use            | Keeps directory clean and reduces selection errors      |


## STEP-BY-STEP USER GUIDE

**How to get here: Dashboard → Business Banking → Recipient Management**
...
<figure><img src="/.gitbook/assets/img_58b865a149e5.png" alt="Figure 3 — Navigate to Recipient Management" width="620"><figcaption></figcaption></figure>
...
<figure><img src="/.gitbook/assets/img_c1865ffab49f.png" alt="Figure 4 — View and Edit Recipient Details" width="620"><figcaption></figcaption></figure>
