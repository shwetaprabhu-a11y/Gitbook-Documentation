__SUMMERVILLE CREDIT UNION · BUSINESS BANKING USER GUIDE · CSUM\-04 of 16__

__Transfer Templates__

Module: Business Banking > Payments > Transfer Templates

__Navigation: Dashboard → Business Banking → Transfer Template__
...
Business Banking > Payments > Transfer Templates

__Navigation__

Dashboard → Business Banking → Transfer Template
...
Role\-based; template creation may require admin privileges

__Key Actions__

Create, Edit, Run, Delete templates

__Regulatory Relevance__

NACHA SEC Code compliance for ACH templates
...
Create ACH template for monthly vendor payment

Eliminates repetitive data entry for regular payments

Payroll Template

Business Admin

Set up payroll template with multiple employee recipients

One\-click payroll execution for all employees

Wire Template

Authorized Signer

Create domestic wire template for recurring high\-value payments

Reduces wire detail errors and speeds up time\-sensitive transfers

Template Execution

Business Owner

Run existing template to execute saved payment

Instant payment execution from saved configuration

__03 STEP\-BY\-STEP USER GUIDE__

__How to get here: Dashboard → Business Banking → Transfer Template__
...
__Step 3: Navigate to Transfer Templates__
...
__Step 4: Click Create Template and Enter Details__
...
__Step 5: Configure Source Account and Schedule__
...
__Step 6: Fill in Advanced Configuration Options__
...
__Step 7: Select the SEC Code__
...
__Step 8: Add Payees to the Template__
...
__Step 9: Confirm the Added Payee__
...
__Step 10: Set Payment Amounts for Each Payee__
...
__Step 12: Verify the New Template in the Dashboard__
