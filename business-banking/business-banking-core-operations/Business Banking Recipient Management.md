__SUMMERVILLE CREDIT UNION · BUSINESS BANKING USER GUIDE · CSUM\-09 of 16__

__Recipient Management__

Module: Business Banking > Payments > Recipient Management

__Navigation: Dashboard → Business Banking → Recipient Management__

*Sources: Summerville Reports Series A \+ Series B | Features: nFinia Documentation Features Spreadsheet*

__01 PRODUCT SUMMARY__

Transfer Account Management \(Recipient Management\) provides a centralized directory of all saved external accounts used for ACH and wire transfers\. The interface displays recipients as color\-coded cards with the recipient name, account type, and status\. Users can search, filter, add new transfer accounts, and view or edit existing account details\.

The feature supports multiple account types including external bank accounts for ACH transfers and wire beneficiary accounts\. Each recipient record stores the account holder name, routing number, account number, and account type\. The management interface also provides a link to copy transfer accounts from other sources\.

For credit unions, recipient management reduces errors in payment processing by maintaining a validated directory of external accounts\. It also reduces onboarding friction — once a business sets up their vendor and payee accounts, executing payments becomes a simple selection rather than manual data entry\.
...
Business Banking > Payments > Recipient Management

__Navigation__

Dashboard → Business Banking → Recipient Management
...
Role\-based; requires Recipient Management permission

__Key Actions__

View recipients, Add new account, Edit account, Delete account, Search

__Regulatory Relevance__

BSA/AML recipient verification, OFAC screening
...
Add new external bank account for vendor payments

Pre\-validates account details to prevent payment errors

Review Recipient Directory

Authorized Signer

Browse saved accounts before initiating transfer

Quick lookup of verified payment destinations

Edit Account Details

Business Admin

Update routing or account number for existing recipient

Maintains accurate payment information

Remove Inactive Recipient

Business Owner

Delete accounts for vendors no longer in use

Keeps directory clean and reduces selection errors

__03 STEP\-BY\-STEP USER GUIDE__

__How to get here: Dashboard → Business Banking → Recipient Management__
...
__Step 3: Navigate to Recipient Management__
...
![Figure 3 — Navigate to Recipient Management](/.gitbook/assets/img_58b865a149e5.png)

*Figure 3 — Navigate to Recipient Management*

__Step 4: View and Edit Recipient Details__
...
![Figure 4 — View and Edit Recipient Details](/.gitbook/assets/img_c1865ffab49f.png)
