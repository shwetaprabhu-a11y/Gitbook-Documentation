__SUMMERVILLE CREDIT UNION · BUSINESS BANKING USER GUIDE · CSUM\-03 of 16__

__Domestic Wire Transfer__

Module: Business Banking > Domestic Wire Transfer

__Navigation: Dashboard → Business Banking → Domestic Wire Transfer__
...
Dashboard → Business Banking → Domestic Wire Transfer
...
Role\-based with wire\-specific limits; dual\-control approval may apply

__Key Actions__

Initiate Wire, Review, Confirm, OTP Verify

__Regulatory Relevance__

Regulation J, BSA/AML, OFAC screening, dual\-control requirements
...
Send same\-day wire for property purchase or closing

Enables time\-critical high\-value payments

Vendor Deposit

Authorized Signer

Wire payment to vendor requiring immediate funds

Same\-day settlement meets urgent payment deadlines

Dual\-Control Wire

Authorized Signer

Submit wire that requires second approval

Dual\-control reduces fraud risk on high\-value transfers

Wire to New Recipient

Business Owner

Select from saved wire transfer accounts

Pre\-configured recipients reduce errors in wire details

__03 STEP\-BY\-STEP USER GUIDE__

__How to get here: Dashboard → Business Banking → Domestic Wire Transfer__
...
__Step 3: Navigate to Domestic Wire Transfer__
...
![Figure 3 — Navigate to Domestic Wire Transfer](/.gitbook/assets/img_75362dbdbb04.png)

*Figure 3 — Navigate to Domestic Wire Transfer*

__Step 4: Select the Wire Recipient__
...
![Figure 4 — Select the Wire Recipient](/.gitbook/assets/img_231cf092d0df.png)

*Figure 4 — Select the Wire Recipient*

__Step 5: Verify the Selected Beneficiary__
...
![Figure 5 — Verify the Selected Beneficiary](/.gitbook/assets/img_8353b8218d8b.png)

*Figure 5 — Verify the Selected Beneficiary*

__Step 6: Enter the Wire Amount__
...
![Figure 6 — Enter the Wire Amount](/.gitbook/assets/img_b67b27aada0b.png)

*Figure 6 — Enter the Wire Amount*

__Step 7: Complete Additional Wire Details and Continue__
...
![Figure 7 — Complete Additional Wire Details and Continue](/.gitbook/assets/img_b4bab0125ea4.png)

*Figure 7 — Complete Additional Wire Details and Continue*

__Step 8: Review and Submit the Wire Transfer__
...
![Figure 8 — Review and Submit the Wire Transfer](/.gitbook/assets/img_31af89da007e.png)
