__SUMMERVILLE CREDIT UNION · BUSINESS BANKING USER GUIDE · CSUM\-08 of 16__

__Approval Settings__

Module: Business Banking > Approvals > Approval Settings

__Navigation: Dashboard → Business Banking → Approval Settings__
...
Business Banking > Approvals > Approval Settings

__Navigation__

Dashboard → Business Banking → Approval Settings
...
Admin\-only; requires Approval Settings permission

__Key Actions__

Set approval thresholds per transaction type

__Regulatory Relevance__

Dual\-control compliance, NCUA examination requirements
...
Set wire transfers to require 2 approvals

Enforces dual\-control for high\-value, irrevocable payments

Streamline Low\-Risk Payments

Business Admin

Set ACH payments to 1 approval for auto\-processing

Reduces friction for routine, low\-risk transactions

Payroll Controls

Business Owner

Require 2 approvals for payroll batch processing

Additional oversight for bulk employee payments

Audit Configuration

Business Admin

Review current approval settings across all types

Ensures settings align with business risk policy

__03 STEP\-BY\-STEP USER GUIDE__

__How to get here: Dashboard → Business Banking → Approval Settings__
...
__Step 3: Navigate to Approval Settings__
...
__Step 4: Configure Thresholds and Save__
