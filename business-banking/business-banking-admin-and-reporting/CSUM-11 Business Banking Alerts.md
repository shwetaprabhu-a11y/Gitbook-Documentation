__SUMMERVILLE CREDIT UNION · BUSINESS BANKING USER GUIDE · CSUM\-11 of 16__

__Business Alerts__

Module: Business Banking > More > Business Alerts

__Navigation: Dashboard → Business Banking → More → Business Alerts__
...
Business Banking > More > Business Alerts

__Navigation__

Dashboard → Business Banking → More → Business Alerts
...
Role\-based; available to users with alert configuration permission

__Key Actions__

Enable/Disable alerts by category, Toggle individual alerts, Expand/Collapse categories

__Regulatory Relevance__

Fraud detection support, Regulation E notification compliance
...
Turn on all security and account change notifications

Immediate awareness of unauthorized access attempts

Configure Wire Alerts

Authorized Signer

Enable alerts for wire transfer activity

Real\-time notification of high\-value wire movements

ACH Activity Monitoring

Business Admin

Set alerts for ACH debits and credits

Monitors automated payment activity for anomalies

Disable Non\-Critical Alerts

Business Owner

Turn off low\-priority alerts to reduce noise

Customizes notification volume to business preferences

__03 STEP\-BY\-STEP USER GUIDE__

__How to get here: Dashboard → Business Banking → More → Business Alerts__
...
__Step 3: Navigate to Business Alerts__
...
__Step 4: Configure Security and Account Alerts__
...
__Step 5: Configure Wire and ACH Alerts__
...
__Step 6: Configure Transfer Alerts and Save__
