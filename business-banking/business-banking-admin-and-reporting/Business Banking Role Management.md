__SUMMERVILLE CREDIT UNION · BUSINESS BANKING USER GUIDE · CSUM\-06 of 16__

__Role Management__

Module: Business Banking > Role Management

__Navigation: Dashboard → Business Banking → Role Management__
...
Dashboard → Business Banking → Role Management
...
Admin\-only; requires Role Management permission

__Key Actions__

View roles, Create role, Edit role, Assign permissions, Set limits, Assign users

__Regulatory Relevance__

Dual\-control compliance, segregation of duties, audit trail
...
Add a new role with specific permissions and limits

Tailors access to business organizational structure

Set Transaction Limits

Business Owner

Configure per\-role ACH, wire, and payment limits

Enforces spending controls aligned with business policy

Assign Users to Role

Business Admin

Move team members into appropriate roles

Ensures each employee has correct level of access

Audit Role Permissions

Business Owner

Review permissions and limits across all roles

Supports compliance audits and internal controls review

View\-only Access

Business Admin

Assign read\-only role to bookkeepers or accountants

Provides visibility without transaction authority

__03 STEP\-BY\-STEP USER GUIDE__

__How to get here: Dashboard → Business Banking → Role Management__
...
__Step 3: Navigate to Role Management__
...
__Step 4: View and Configure Role Permissions__
...
__Step 5: Scroll to See All Permission Categories__
...
__Step 6: Set Transaction Limits for the Role__
...
__Step 7: View Users Assigned to the Role__
...
__Step 8: Review Role Settings__
...
__Step 9: Edit an Existing Role__
...
__Step 10: Create a New Role — Enter the Role Name__
...
__Step 11: Confirm the Role Name and Proceed__
...
__Step 12: Select Feature Privileges for the New Role__
...
__Step 13: Configure Detailed Entitlements and Save__
