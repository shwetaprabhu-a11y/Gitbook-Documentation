...
Module: nFinia Digital Banking > Move Money > Other You
...
Move Money > Transfer to Other You

Recipient Type

Other You at the same credit union

Multi-Recipient

Supported — split payment to multiple You in one transaction
...
4 (From → Recipient → Amount → Confirm)

Related Reports

CSUM-06 (Move Money Hub), CSUM-11 (Recipient Management)
