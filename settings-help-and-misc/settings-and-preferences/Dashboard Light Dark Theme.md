...
The Dashboard Light & Dark Theme feature provides Summerville Federal Credit Union members with the ability to switch their nFinia Online Banking dashboard between a Light Mode and a Dark Mode visual appearance. This personalization option allows members to choose the interface aesthetic that best suits their preference, environment, and accessibility needs.
...
**At a Glance**
  ...
  **User Roles**             All authenticated members
...
Theme personalization is increasingly table stakes in consumer-facing digital products. By offering both Light and Dark modes, Summerville FCU demonstrates that its digital banking platform matches the experience quality members expect from premium apps like Apple, Google, and leading neobanks. This directly supports member satisfaction and digital adoption metrics.
...
![Summerville FCU Dashboard -- Light Mode](media/4d84470d6d89d8a6fa87d3208abb4fab251f5cf4.png "Summerville FCU Dashboard – Light Mode"){width="3.9583333333333335in" height="5.947916666666667in"}
...
![Summerville FCU Dashboard -- Dark Mode](media/8c7bc558be6f326e79504593b267c6ca1205b01c.png "Summerville FCU Dashboard – Dark Mode"){width="3.8541666666666665in" height="5.84375in"}

*Figure 2: Summerville FCU Dashboard -- Dark Mode*

**3.3 Decision Points & Branching**

• Theme selection persists across sessions via user preference stored server-side; the member does not need to re-select on each login.
...
Theme switching is instant with no page reload required. The system applies the new color palette via CSS class toggling. The member sees an immediate visual transition. The preference is saved automatically and reflected on the next login.
...
Both themes render the same set of dashboard components. The table below documents each component and how it adapts between Light and Dark modes.
  ...
  **Task**                  **Navigation Path**                  **Who Can Do It**   **Notes**
  Switch to Dark Mode       Settings \> Theme or header toggle   All members         Persists across sessions
  Switch to Light Mode      Settings \> Theme or header toggle   All members         Default theme for new users
  View account balances     Dashboard \> Balances                All members         Identical in both themes
  Initiate Quick Transfer   Dashboard \> Quick Transfer widget   All members         Same form in both themes
  View Credit Score         Dashboard \> Credit Score widget     All members         Gauge adapts to theme colors
  Access Related Links      Dashboard \> Related Links sidebar   All members         Links adapt to theme
  ------------------------- ------------------------------------ ------------------- ------------------------------
