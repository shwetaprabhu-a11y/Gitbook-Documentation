...
**At a Glance**
  ...
  **Document Types**         Monthly Statements, Credit Card Statements, Disclosures, Notices
  **Delivery Options**       eStatements (email notification) or Paper (mailed, may incur \$3/month fee)
  **Regulatory Relevance**   Regulation E (electronic disclosures), E-SIGN Act compliance, record retention
  -------------------------- --------------------------------------------------------------------------------------
...
**2. Use Cases**
  ...
  **View Monthly Statement**          Account Holder    Navigates to eStatements, selects document type and member \#, views available monthly statements organized by date          Eliminates need for paper statements; instant access reduces member service calls
  **Review Credit Card Statements**   Card Holder       Selects Credit Card Statements tab to view billing statements including year-end summaries                                   Consolidated view of all card activity for budgeting and tax purposes
  **Switch to Paperless**             Any Member        Opens Delivery Settings, selects eStatements delivery mode, confirms email address for notifications                         Reduces CU mailing costs; aligns with sustainability goals; faster delivery to member
  **Switch to Paper Delivery**        Any Member        Opens Delivery Settings, selects Paper delivery, acknowledges potential \$3/month fee, confirms mailing address              Full member choice; fee transparency ensures informed decision
  **Search Historical Statements**    Account Holder    Uses the Statement Search tab to find specific statements by date range or criteria                                          Quick retrieval for tax filing, dispute resolution, or audit purposes
...
-   Member must have an active account (deposit, loan, or credit card) with Summerville FCU

-   Member must be authenticated and logged into the nFinia digital banking platform

-   eStatements feature must be enabled by the credit union in platform configuration

-   For delivery settings changes, a valid email address must be on file for eStatements mode
...
<figure><img src="/.gitbook/assets/eStatements_Dashboard_Account_Overview.png" alt="Dashboard / Account Overview page" width="620"><figcaption>Figure 1: Dashboard — Account Overview starting point</figcaption></figure>
...
<figure><img src="/.gitbook/assets/eStatements_More_Menu_Hub.png" alt="More Menu hub with self-service features" width="620"><figcaption>Figure 2: More Menu — Self-service feature hub with eStatements highlighted</figcaption></figure>
...
<figure><img src="/.gitbook/assets/eStatements_Landing_Page.png" alt="eStatements landing page" width="620"><figcaption>Figure 3: eStatements landing page with member information and upcoming payments</figcaption></figure>
...
<figure><img src="/.gitbook/assets/eStatements_Documents_View_Tabs.png" alt="eStatements documents view with tabs" width="620"><figcaption>Figure 4: eStatements document browser with Monthly Statements, Credit Card Statements, and Notices</figcaption></figure>

<figure><img src="/.gitbook/assets/eStatements_Main_View_Button.png" alt="eStatements main view with View eStatements button" width="620"><figcaption>Figure 5: eStatements view with View eStatements action button</figcaption></figure>
...
<figure><img src="/.gitbook/assets/eStatements_Delivery_Settings_Email_Mode.png" alt="Delivery Settings tab" width="620"><figcaption>Figure 5b: Delivery Settings tab — accessible from the eStatements page header</figcaption></figure>
...
<figure><img src="/.gitbook/assets/eStatements_Delivery_Settings_Email_Mode.png" alt="Delivery Settings - eStatements (email) mode" width="620"><figcaption>Figure 6: Delivery Settings — eStatements mode with email notification</figcaption></figure>
...
<figure><img src="/.gitbook/assets/eStatements_Delivery_Settings_Paper_Mode.png" alt="Delivery Settings - Paper delivery mode" width="620"><figcaption>Figure 7: Delivery Settings — Paper delivery mode with mailing address and fee disclosure</figcaption></figure>
...
<figure><img src="/.gitbook/assets/eStatements_Delivery_Settings_Email_Mode.png" alt="Submit button on Delivery Settings page" width="620"><figcaption>Figure 8: Submit button — visible at the bottom of the Delivery Settings page after selecting a delivery mode</figcaption></figure>
...
Upon successful submission of delivery settings, the system saves the preference and the page reflects the updated delivery mode. For eStatements, the confirmation shows the email address where notifications will be sent. For paper delivery, the mailing address is confirmed along with the fee disclosure.
...
**4.1 eStatements Landing Page**

The eStatements landing page provides access to electronic documents and delivery preferences through a tabbed interface. The page includes member identification, document type selection, and statement availability status.

  --------------------------------- ------------------ --------------------------------------------------------------------------------------------- -----------------------------------------
  **Field / Element**               **Type**           **Description**                                                                               **Notes**
  eStatements / Delivery settings   Tab Navigation     Switches between statement viewing and delivery preference management                         eStatements tab active by default
  Select document type              Dropdown           Selects the type of document to view (eStatements is the default option)                      May include other document types
  Member \#                         Dropdown           Selects the membership account to view statements for; displays account holder name           Required; supports multiple memberships
  Opt-in Status                     Label              Displays current enrollment: "You are opted into eStatements" with a "Change to paper" link   Inline link for quick delivery change
  Email address                     Label              Shows the registered email for eStatements notifications                                      Partially masked for privacy
  View eStatements                  Button (Primary)   Loads available statements for the selected membership                                        Triggers document retrieval
  --------------------------------- ------------------ --------------------------------------------------------------------------------------------- -----------------------------------------
...
After loading statements, the member sees a tabbed document browser with three sections. Monthly Statements and Credit Card Statements are displayed with dates and can be opened individually. (See Figures 4--5 in Section 3.)
  ...
  -------------------------------------------- ---------------- -------------------------------------------------------------------------------------------------------- ------------------------------------------
  **Field / Element**                          **Type**         **Description**                                                                                          **Notes**
  Documents / Disclosures / Statement search   Tab Navigation   Three tabs to filter document types: account documents, regulatory disclosures, and search by criteria   Documents tab active by default
  Monthly Statement                            Document List    Chronological list of monthly account statements (e.g., Mar 2026, Feb 2026, Jan 2026)                    PDF icon indicates downloadable document
  Credit Card Statements                       Document List    Billing period statements and year-end summaries for credit card accounts                                Includes year-end summary documents
  Notices                                      Document List    System-generated notices such as "Insufficient Funds" alerts with dates                                  Date-stamped for audit trail
  View all past documents                      Link             Expands the list to show the complete statement history beyond the default view                          Available for each document category
  -------------------------------------------- ---------------- -------------------------------------------------------------------------------------------------------- ------------------------------------------
...
The Delivery Settings page allows members to control how their statements are delivered. The page supports switching between electronic and paper delivery with full disclosure of any associated fees. (See Figures 6--7 in Section 3.)
  ...
  **Field / Element**   **Type**           **Description**                                                                           **Notes**
  ...
  Submit                Button (Primary)   Saves the selected delivery preference                                                    Applies to selected membership only
  --------------------- ------------------ ----------------------------------------------------------------------------------------- -------------------------------------
