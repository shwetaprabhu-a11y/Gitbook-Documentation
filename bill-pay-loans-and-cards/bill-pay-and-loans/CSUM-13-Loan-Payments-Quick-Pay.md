...
Auto, Personal, Consumer, Mortgage, Line of Credit, Credit Card

Payment Sources

Any linked CU account; external account for loan repayments

Steps

2 (Select Loan → Enter Amount)

Same-Day Posting

Available when submitted before daily cut-off

Related Reports

CSUM-06 (Move Money Hub), CSUM-21 (Skip A Pay)
