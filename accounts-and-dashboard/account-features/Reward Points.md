...
**At a Glance**
  ...
  **Attribute**          **Detail**
  ...
  Access Level           Account-level (visible to members with credit card products)
...
These use cases reflect the primary ways credit union members interact with their credit card and reward point information. For Summerville FCU, providing this self-service experience directly in the digital banking platform eliminates the need for members to call in or use a separate card processor portal, creating a unified experience that strengthens the credit union\'s digital relationship with its members.
...
\- Credit card must be linked to the member\'s digital banking profile by the FI.
...
\- If the member has no credit card products, the credit card section does not appear in the Accounts view.

\- If the reward points program is not enabled on the card, the reward points row is hidden.

\- If the card is locked, the member sees \'Locked\' status and must unlock before certain card actions are available.
...
\- Session timeout during redemption: The member is redirected to login; partial redemptions are not processed.

**4. Feature Overview (UI Walkthrough)**

**Credit Card Account Detail Screen**

This is the primary screen members see when selecting a credit card account. It provides a complete snapshot of the card\'s financial status and reward points.
  ...
  **Field / Element**        **Type**         **Description**                                                                                      **Notes**
  ...
  Status Toggle              Toggle           Locked / Unlocked card status with inline toggle switch                                              Member can lock/unlock card instantly
...
The Reward Points & Credit Card Management module delivers a self-service, transparent experience for Summerville FCU members to manage their credit card accounts and maximize the value of their reward programs. By integrating real-time card data, reward balances, and redemption capabilities directly into the nFinia digital banking platform, the credit union eliminates the need for members to navigate separate card processor portals or contact the call center for routine reward inquiries.
