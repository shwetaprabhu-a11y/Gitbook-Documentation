**  SUMMERVILLE CREDIT UNION  ·  CONSOLIDATED MEMBER GUIDE  ·  CSUM-24 of 30**

**Recent Activities & My Insights**

Module: nFinia Digital Banking > More > Recent Activities / My Insights
...
More > Recent Activities & My Insights

Recent Activities

All events since last login in reverse chronological order

Insights Categorisation

Automatic merchant category code-based transaction grouping

Insights Views

Overview (income vs. spend), Insights tab (category breakdown)

Data Source

Transaction history across all accounts in active membership

Related Reports

CSUM-02 (Dashboard), CSUM-03 (Account Overview)
...
| ------------------------------ | ---------------------------------------------------------------------- | ------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Post-Login Security Check      | You verifying no unauthorized activity                             | Review Recent Activities immediately after login                   | Instant detection of unauthorized transfers or login events                                                                                                                                                       |
| Monthly Spending Review        | You reviewing their spending categories                            | Open My Insights for category-level spending breakdown             | Identifies over-spending areas at a glance without manual ledger review                                                                                                                                           |
| Income vs. Spending Comparison | You monitoring monthly cash flow                                   | View Overview in My Insights for income/expense totals             | Quick cash flow health check with no manual calculation required                                                                                                                                                  |
| Transaction Audit              | You researching where money was spent                              | Drill into a spending category in Insights to see all transactions | Data-driven basis for identifying and reducing discretionary spending                                                                                                                                             |
